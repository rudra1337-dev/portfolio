            ...
            {[
              ...
              <MagneticWrapper key={social.label} strength={0.4}>
                <motion.a
                  ...
                  className="p-3 rounded-full bg-secondary/80 backdrop-blur-sm border border-primary/10 hover:bg-primary hover:text-primary-foreground transition-colors duration-300"
