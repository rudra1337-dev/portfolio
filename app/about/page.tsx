...
import { personalInfo, aboutData, skills } from "@/lib/data"
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <ul className="space-y-4">
                  {aboutData.responsibilities.map((item, index) => (
                    <li
                      key={index}
              ...
              >
                {aboutData.strengths.map((strength, index) => (
                  <div
                    key={strength.title}
                    className="p-6 bg-card border border-border rounded-2xl hover:border-primary/50 transition-all duration-300"
                    style={{
                      transitionDelay: `${index * 100}ms`,
                    }}
                  >
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {allSkills.map((skill) => (
                <span
                  key={skill.name}
                  className="px-4 py-2 bg-card border border-border rounded-full text-sm font-medium text-foreground hover:bg-primary hover:text-primary-foreground transition-colors cursor-default"
                >
                  {skill.name}
                </span>
              ))}
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="p-6 bg-card border border-border rounded-2xl">
                ...
                <div className="flex flex-wrap gap-2">
                  {aboutData.personality.hobbies.map((hobby) => (
                    <span
                      key={hobby}
